        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16 animate-fade-in-up">
            <h2 className="text-4xl md:text-5xl font-serif font-bold text-foreground mb-6">
              Our <span className="bg-gradient-to-r from-blue-600 to-blue-400 bg-clip-text text-transparent">Success Stories</span>
            </h2>
            ...
            {projects.map((project, index) => (
              ...
              >
                ...
                <div className="relative overflow-hidden h-48">
                  ...
                  />
                  <div className="absolute inset-0 bg-gradient-to-t from-blue-600/90 to-blue-400/90 opacity-0 group-hover:opacity-90 transition-opacity duration-300 flex items-center justify-center">
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <div key={phase.step} className="text-center">
                  <div className="w-16 h-16 bg-gradient-to-r from-blue-600 to-blue-400 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">
                    {phase.step}
                  </div>
